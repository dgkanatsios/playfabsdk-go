...
// (see the GCM documentation, here: http://developer.android.com/google/gcm/client.html).
    ...
    SendPushNotificationConfirmation bool `json:"SendPushNotificationConfirmation,omitempty"`
}
...
// and virtual currencies
    ...
    CanBecomeCharacter bool `json:"CanBecomeCharacter,omitempty"`
...
// non-cached version of the content during development, set this to false. Default is true.
    ThruCDN bool `json:"ThruCDN,omitempty"`
}
...
type GetFriendLeaderboardAroundPlayerRequestModel struct {
    ...
    IncludeFacebookFriends bool `json:"IncludeFacebookFriends,omitempty"`
    // IncludeSteamFriends indicates whether Steam service friends should be included in the response. Default is true.
    IncludeSteamFriends bool `json:"IncludeSteamFriends,omitempty"`
    // MaxResultsCount maximum number of entries to retrieve. Default 10, maximum 100.
    MaxResultsCount int32 `json:"MaxResultsCount,omitempty"`
...
// GetLeaderboardForUsersCharactersResult note that the Position of the character in the results is for the overall leaderboard.
...
type GetSharedGroupDataRequestModel struct {
    ...
    GetMembers bool `json:"GetMembers,omitempty"`
...
type GrantCharacterToUserRequestModel struct {
    ...
    CatalogVersion string `json:"CatalogVersion,omitempty"`
    // CharacterName non-unique display name of the character being granted (1-20 characters in length).
    CharacterName string `json:"CharacterName,omitempty"`
...
type MatchmakeRequestModel struct {
    ...
    StartNewIfNoneFound bool `json:"StartNewIfNoneFound,omitempty"`
...
// true.
    RequireBothUsernameAndEmail bool `json:"RequireBothUsernameAndEmail,omitempty"`
    // TitleId unique identifier for the title, found in the Settings > Game Properties section of the PlayFab developer site when a
// title has been selected.
    TitleId string `json:"TitleId,omitempty"`
    // Username playFab username for the account (3-20 characters)
...
type UninkOpenIdConnectRequestModel struct {
    // ConnectionId a name that identifies which configured OpenID Connect provider relationship to use. Maximum 100 characters.
    ConnectionId string `json:"ConnectionId,omitempty"`
}
...
type UserAccountInfoModel struct {
    ...
    // NintendoSwitchDeviceIdInfo nintendo Switch account information, if a Nintendo Switch account has been linked
...
type UserSettingsModel struct {
    ...
    GatherDeviceInfo bool `json:"GatherDeviceInfo,omitempty"`
    // GatherFocusInfo boolean for whether this player should report OnFocus play-time tracking.
    GatherFocusInfo bool `json:"GatherFocusInfo,omitempty"`
...
type ValidateAmazonReceiptRequestModel struct {
    // CatalogVersion catalog version to use when granting receipt item. If null, defaults to primary catalog.
    CatalogVersion string `json:"CatalogVersion,omitempty"`
...
// commonly follows the subject_verb_object pattern (e.g. player_logged_in).
    ...
    // Timestamp the time (in UTC) associated with this event. The value dafaults to the current time.
    Timestamp time.Time `json:"Timestamp,omitempty"`
}
