...
type ActionsOnPlayersInSegmentTaskSummaryModel struct {
	...
	ErrorWasFatal bool `json:"ErrorWasFatal,omitempty"`
...
type GetContentUploadUrlResultModel struct {
	// URL uRL for uploading content via HTTP PUT method. The URL will expire in approximately one hour.
...
type SetupPushNotificationRequestModel struct {
	...
	OverwriteOldARN bool `json:"OverwriteOldARN,omitempty"`
...
type UpdateCatalogItemsRequestModel struct {
	...
	// always set it.
	SetAsDefaultCatalog bool `json:"SetAsDefaultCatalog,omitempty"`
}
...
type UpdatePolicyRequestModel struct {
	...
	OverwritePolicy bool `json:"OverwritePolicy,omitempty"`
